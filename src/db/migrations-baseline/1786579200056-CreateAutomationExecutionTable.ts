...
export class CreateAutomationExecutionTable1786579200056 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DO $$ BEGIN
        CREATE TYPE "automation_execution_purpose_enum" AS ENUM ('manual', 'funnel_signup_payment_reminder', 'funnel_signup', 'funnel_payment', 'funnel_abandoned_checkout_reminder');
      EXCEPTION
